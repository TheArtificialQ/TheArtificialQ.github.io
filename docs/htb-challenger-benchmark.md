...
*Last updated: 2026-08-12 11:00:08 UTC*
...
| <img src="{{ "/assets/images/qwen-icon.svg" | relative_url }}" alt="qwen icon" width="22" height="22"> [`qwen/qwen3.8-max`]({% post_url 2026-08-11-solving-htb-challenges-with-qwen-qwen3.8-max %}) | 47.5% | $2.00 | 29.0 | 00:15:32 | 0.96M |
